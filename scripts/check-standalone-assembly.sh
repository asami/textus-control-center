...
rg -F -- '"name": "textus-control-center"' "$component_descriptor" >/dev/null
rg -F -- '"textus.component.textus-control-center.datastores.application.policy": "local-default"' "$component_descriptor" >/dev/null
rg -F -- 'textus.component.textus-control-center.datastores.application.policy: local-default' "$assembly_descriptor" >/dev/null
rg -F -- 'name: textus-supervisor' "$assembly_descriptor" >/dev/null
...
rg -F -- 'textus.component.textus-control-center.datastores.application.policy: local-default' "$standalone_assembly" >/dev/null
rg -F -- 'name: textus-supervisor' "$standalone_assembly" >/dev/null
