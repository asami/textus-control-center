...
Stage Status:
- Current status: DONE
- Current step: Phase 1 closed on Jul. 18, 2026.
- Owner: Textus Control Center Phase 1
...
Phase 1 establishes the first usable Textus Control Center capability: an operator can
...
- Bootstrap `textus-control-center` as a Cozy-generated CAR.
...
- Textus Control Center does not discover arbitrary JVM or operating-system processes.
- Textus Control Center does not send process signals or execute lifecycle commands.
...
- D (DONE): TA-04 - Provide command and REST projections.
- E (DONE): TA-05 - Provide the operation-backed Web inventory UI.
- F (DONE): TA-06 - Integrate `textus-launcher` registration.
- G (DONE): TA-07 - Integrate canonical `cncf-launcher` registration.
- H (DONE): TA-08 - Complete cross-launcher executable scenarios and Phase 1
  closure.
...
- [x] TA-04: Provide command and REST projections.
- [x] TA-05: Provide the operation-backed Web inventory UI.
- [x] TA-06: Integrate `textus-launcher` registration.
- [x] TA-07: Integrate canonical `cncf-launcher` registration.
- [x] TA-08: Complete cross-launcher validation and close Phase 1.
...
The Phase 1 demonstration starts Textus Control Center and representative managed
Subsystems through:
...
- a Textus Control Center command list operation;
- the corresponding automatic REST list endpoint;
- the Textus Control Center Web inventory page.

The demonstration must also show that an unavailable Textus Control Center endpoint
