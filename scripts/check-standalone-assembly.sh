...
rg -F -- '"textus.component.org.simplemodeling.textus.control-center.datastores.application.policy": "local-default"' "$component_descriptor" >/dev/null
...
rg -F -- 'textus.component.org.simplemodeling.textus.control-center.datastores.application.policy: local-default' "$assembly_descriptor" >/dev/null
...
rg -F -- 'textus.component.org.simplemodeling.textus.control-center.datastores.application.policy: local-default' "$standalone_assembly" >/dev/null
